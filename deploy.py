...
# Connect to Ethereum network (use testnet)
infura_url = "https://goerli.infura.io/v3/YOUR_INFURA_KEY"  # Replace with your Infura key
...
# Set up account (replace with your private key)
